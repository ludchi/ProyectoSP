/*
OBJETIVO: Transmitir video (frames JPG en Base64) vía MQTT para el análisis de
fatiga. INTEGRANTES: CASTRO LUNA CESAR ARMANDO, ESPINOZA BRAVO LUDWIG, LOZANO
CARDONA ANGEL JOSUE PROYECTO: Sistema de registro de Asistencias y Desgaste
Laboral
*/
...
// ===========================
const char *ssid = "iPhone de Ludwig";
const char *password = "123456789";
const char *mqtt_server = "172.20.10.4"; // IP de tu computadora (Mosquitto)
...
void setup() {
  WRITE_PERI_REG(RTC_CNTL_BROWN_OUT_REG,
                 0); // Desactivar el detector de caídas de voltaje
  ...
  config.jpeg_quality =
      30; // Mayor número = Más comprimida (Menos peso en bytes)
  config.fb_count = 1;
...
void loop() {
  ...
  // Usar beginPublish para transmitir en trozos y evitar desbordar el buffer de
  // golpe
  if (client.beginPublish(mqtt_topic_cam, encoded.length(), false)) {
    ...
    Serial.println(
        "Fallo al enviar la imagen (El tamaño superó el buffer ampliado).");
  }
